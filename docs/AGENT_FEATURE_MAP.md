...
ADGA Suite currently has 8 agent Markdown files. These same names are valid `agent` values in `cloudflare/state/agent-job.schema.json`:
...
| Persistent deal memory | `docs/ADGA_AGENTIC_OPERATING_SPINE.md`, `docs/ADGA_AGENTIC_TASKS.json` | `agents/sales/SKILL.md`, `agents/conductor/SKILL.md`, `agents/communication/SKILL.md`, `agents/voice/SKILL.md`, `agents/payments/SKILL.md` | `cloudflare/state/deal-memory.schema.json`, `cloudflare/state/agent-event.schema.json` |
...
| Calendar and meeting invites | `docs/PRODUCT_POSITIONING_AND_TOOL_BACKLOG.md` | `agents/operations/SKILL.md`, `agents/communication/SKILL.md`, `agents/voice/SKILL.md`, `agents/conductor/SKILL.md` | `cloudflare/state/calendar-event.schema.json`, `cloudflare/state/prepared-action.schema.json`, `cloudflare/state/agent-event.schema.json` |
...
| Documents and R2 storage | `docs/PRODUCT_POSITIONING_AND_TOOL_BACKLOG.md`, `docs/PRODUCTION_RUNBOOK.md` | `agents/documents/SKILL.md`, `agents/conductor/SKILL.md` | `cloudflare/state/document.schema.json`, `cloudflare/state/agent-event.schema.json` |
...
| Maps (persistence) — nodes / edges / positions | `docs/ADGA_DEAL_SYSTEM.md` | `agents/conductor/SKILL.md`, `agents/operations/SKILL.md` | `cloudflare/state/dealflow-map.schema.json` + D1 tables: `maps`, `map_nodes`, `map_edges` (migration `0012_maps.sql`) |
...
| Calendar surface | `docs/PRODUCT_POSITIONING_AND_TOOL_BACKLOG.md` | `agents/operations/SKILL.md`, `agents/communication/SKILL.md`, `agents/voice/SKILL.md` | `cloudflare/state/calendar-event.schema.json` |
...
| Admin Section (team, roles, audit, workspace — owner only) | `docs/PRODUCT_POSITIONING_AND_TOOL_BACKLOG.md` | `agents/operations/SKILL.md`, `agents/conductor/SKILL.md` | `cloudflare/state/audit-log.schema.json` + `cloudflare/state/agent-event.schema.json` |
| Agentic outcomes dashboard | `docs/ADGA_AGENTIC_OPERATING_SPINE.md`, `docs/ADGA_AGENTIC_TASKS.json` | `agents/intelligence/SKILL.md`, `agents/operations/SKILL.md`, `agents/conductor/SKILL.md` | `cloudflare/state/agentic-outcomes.schema.json`, `cloudflare/state/agent-job.schema.json`, `cloudflare/state/prepared-action.schema.json` |
