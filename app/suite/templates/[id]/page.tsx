...
import { TEMPLATES, getTemplate, type TemplateNode, type TemplateNodeKind } from "@/lib/templates";
...
export default async function TemplateDetailPage({ params }: PageProps) {
  ...
  const kindOrder: TemplateNodeKind[] = ["company", "contact", "document", "task", "call", "meeting", "action"];
